...
while true
    ...
    % Visit up neighbor in configuration space
    if (i > 1)
        ni = i - 1;
    else
        ni = nrows;
    ...
    % Visit down neighbor in configuration space
    if (i < nrows)
        ni = i + 1;
    else
        ni = 1;
    ...
    % Visit left neighbor in configuration space
    if (j > 1)
        nj = j - 1;
    else
        nj = ncols;
    ...
    % Visit right neighbor in configuration space
    if (j < ncols)
        nj = j + 1;
    else
        nj = 1;
